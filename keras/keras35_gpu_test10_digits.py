...
hist = model.fit(x_train, y_train,
                 epochs = 50, batch_size = 20000, validation_split=0.2,
                 verbose=1,
                 )
end_time = time.time()             
...
py311
loss : 2.1049838066101074
acc : 0.34
acc_score : 0.3388888888888889
걸린시간 : 3.82 초


tf29x-gpu
loss : 2.2080814838409424
acc : 0.32
acc_score : 0.32222222222222224
걸린시간 : 1.98 초
