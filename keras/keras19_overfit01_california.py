...
# r2:  0.4763370011336039
# mse:  0.6750455237473852
# RMSE :  0.8216115406610263
...
# plt.plot(hist.history['loss'][18:], c='red', label='loss')          # y값만 넣으면 시간순으로 그려줌.
# plt.plot(hist.history['val_loss'][18:], c='blue', label='val_loss')        #[18:]을 넣는건 그래프를 시각화 했을 때 특정값이 튀면 나머지가 뒤에서 y=0쪽에서 수럽하니까 애초에 튀는 그래프를 빼버리는거다. 
