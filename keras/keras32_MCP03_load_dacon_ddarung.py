...
# filepath = ''.join([path, 'k35_', date,'_', filename])      # ''은 파일명을 일단 공백으로 만든다. if, 'aa'가 있으면 aa 뒤로 join에 적어 놓은 것들이 들어온다.
...
model = load_model(path +'k35_0914_1411_0174-2860.5334.keras')
